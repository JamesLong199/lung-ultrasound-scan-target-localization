# Plot the 3D position error distribution of 3 targets under 3 HPE models
...
plt.legend([bp_list[0]["boxes"][0], bp_list[1]["boxes"][0], bp_list[2]["boxes"][0]],
           ['ViTPose-Large', 'ViTPose-Base', 'OpenPose'], loc='upper left', prop={'size': 15})

plt.xticks([(i + 1) * BIG_INTERVAL + SMALL_INTERVAL for i in range(3)], ['Target1', 'Target2', 'Target4'], fontsize=14)
plt.tick_params(axis='y', labelsize=12)
plt.ylabel('Position Error (mm)', fontsize=15)
