...
class Fp16OptimizerHook(OptimizerHook):
    ...
    2. Copy gradients from fp16 model to fp32 models.
    3. Update fp32 models.
    4. Copy updated parameters from fp32 models to fp16 model.
    ...
    def before_run(self, runner):
        ...
        1. Make a master copy of fp32 models for optimization.
        2. Convert the main model from fp32 to fp16.

        Args:
            runner (:obj:`mmcv.Runner`): The underlines training runner.
        """
        # keep a copy of fp32 models
